...
- No SSID/network polling or ignore-battery-optimizations; monitoring FGS is `specialUse|location` so SSID is readable while watching. Once-daily GitHub Releases GET is allowed.
