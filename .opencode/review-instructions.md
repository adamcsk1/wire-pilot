...
- Battery and process lifetime: monitoring foreground service runs only while control is enabled or timed-paused; no polling or battery-optimization prompt.
