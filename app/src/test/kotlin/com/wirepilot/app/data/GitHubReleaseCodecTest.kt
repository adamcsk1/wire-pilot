...
class GitHubReleaseCodecTest {
  ...
  @Test
  fun unescapesControlCharactersInTag() {
    val body = """{"tag_name":"1\n0\r1x\ty","html_url":"https://github.com/adamcsk1/wire-pilot/releases/tag/1.0.1"}"""
    assertEquals("1\n0\r1x\ty", GitHubReleaseCodec.parse(body)?.tagName)
  }
